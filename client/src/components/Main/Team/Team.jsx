        ...
        <section className="team">
            <div className="container">
                <div className="row">
                        ...
                        <div className="team-member">
                            ...
                            <ul>
                                <li className="hover-icon">
                                    <a href="javascript:void(0)"><i className="fa fa-facebook"
                                                                    aria-hidden="true"></i></a>
                                </li>
                                <li className="hover-icon">
                                    <a href="javascript:void(0)"><i className="fa fa-twitter"
                                                                    aria-hidden="true"></i></a>
                                </li>
                                <li className="hover-icon">
                                ...
                                <li className="hover-icon">
                                    <a href="javascript:void(0)"><i className="fa fa-pinterest" aria-hidden="true"></i></a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="team-member">
                            <div className="img-block"><img src="/images/team/member1.jpg" alt="team1" /></div>
                            <ul>
                                <li className="hover-icon">
                                    <a href="javascript:void(0)"><i className="fa fa-facebook"
                                                                    aria-hidden="true"></i></a>
                        ...
                        <div className="team-info">
                            <h5 className="name">LINA MARZOUKI</h5>
                            <p>Consultant</p>
                        </div>
                    </div>
                </div>
